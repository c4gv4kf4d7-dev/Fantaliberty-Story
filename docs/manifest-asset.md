...
| `bg_macintosh` | — | Il banco della registrazione col Mac gia' dentro l'immagine. Consegnato insieme ai due esterni ridisegnati e tenuto nel repo, ma **nessuna scena lo usa**: la registrazione monta il Mac come oggetto (`prop_mac_terminale`) sopra `bg_esterno_ingresso`, com'e' stato deciso |
