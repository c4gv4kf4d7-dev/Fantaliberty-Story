...
| `bg_staff_door_locked` | S1 | Zona 5, la porta STAFF ONLY prima dello sblocco: porta a vetri moderna, coerente con lo Steve Jobs Theater, completamente chiusa, targhetta STAFF ONLY, lettore badge visibile in stato **neutro/rosso**, nessuna persona, spazio per il box del dialogo. **In coda** (`meta.assetiInArrivo`), non ancora disegnata |
